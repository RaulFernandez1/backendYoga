...
import com.pruebaTFG.myapp.services.impl.ICustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.List.of("http://localhost:4001")); // ✅ origen del frontend
        configuration.setAllowedMethods(java.util.List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(java.util.List.of("*"));
        configuration.setAllowCredentials(true); // si necesitas enviar cookies o Authorization header
